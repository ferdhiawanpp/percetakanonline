						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<a href="<?= base_url('detail-desain/' . $value['spanduk_id']) ?>" class="label label-primary"><i class="fa fa-eye"></i> Lihat</a>
									</td>
								</tr>
							<?php
								$no++;
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<a href="<?= base_url('detail-desain/' . $value['stiker_id']) ?>" class="label label-primary"><i class="fa fa-eye"></i> Lihat</a>
									</td>
								</tr>
							<?php
								$no++;
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<a href="<?= base_url('detail-desain/' . $value['kartu_id']) ?>" class="label label-primary"><i class="fa fa-eye"></i> Lihat</a>
									</td>
								</tr>
							<?php
								$no++;
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<a href="<?= base_url('detail-desain/' . $value['brosur_id']) ?>" class="label label-primary"><i class="fa fa-eye"></i> Lihat</a>
									</td>
								</tr>
							<?php
								$no++;
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td><?= $value['kalender_cetakisicover'] ?></td>
									<td><?= $value['kalender_jumlah'] ?></td>
									<td>
										<a href="<?= base_url('detail-desain/' . $value['kalender_id']) ?>" class="label label-primary"><i class="fa fa-eye"></i> Lihat</a>
									</td>
								</tr>
							<?php
								$no++;

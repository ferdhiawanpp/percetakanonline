	...
	<div class="card">
		<div class="card-body">
			<div class="row d-print-none">
				<div class="col-6">
					<button type="button" onclick="return window.history.back();" class="btn btn-sm btn-outline-primary"><i class="fa fa-arrow-left"></i></button>
				</div>
				<div class="col-6">
					<button style="float: right" type="button" onclick="window.print()" class="btn btn-primary btn-sm"><i class="fa fa-print"></i></button>
				</div>
			</div>
			<br>
			<div>
				<div class="laporan-header">
					<h3>Jadi Jaya Printing</h3>
				</div>
				<div class="laporan-header">
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td><?= ucfirst($value['kalender_cetakisicover']) ?></td>
									<td><?= ucfirst($value['kalender_jumlahhalaman']) ?></td>
									<td><?= $value['kalender_jumlah'] ?> rim</td>
				...
				<div class="row">
					...
					<div class="col-6 text-center">
						...
						<br>
						<br>
						<p><b><u>Eko Priyo Jatmiko, S.Pd</u></b></p>
					</div>
				</div>
			</div>
		</div>

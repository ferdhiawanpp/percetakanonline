...
class BayarController extends CI_Controller
{
	...
	{
		$keranjang1 = $this->BayarModel->lihat_keranjang_status($this->session->userdata('session_id'), 'belum')->row_array();
		$keranjang = (isset($keranjang1)) ? $keranjang1 : array("keranjang_id" => 0, "keranjang_total" => 0);
		$data = array(
			'keranjang' => $keranjang,
	...
	public function selesai($bank, $id)
	{
		...
		$data = array(
			...
			'title' => 'Terima Kasih | Jadi Jaya Printing'
		);
		$this->load->view('frontend/templates/header', $data);
	...
	public function konfirmasi($id)
	{
		if (isset($_POST['konfirmasi'])) {
			...
			$data = array(
				'title' => 'Konfirmasi Pembayaran | Jadi Jaya Printing',

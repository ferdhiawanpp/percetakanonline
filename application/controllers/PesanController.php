...
class PesanController extends CI_Controller
{
	...
	public function pesanSpanduk()
	{
		...
		$data = array(
			'title' => 'Pesan Spanduk | Jadi Jaya Printing'
		);
	...
	public function pesanStiker()
	{
		...
		$data = array(
			'title' => 'Pesan Stiker | Jadi Jaya Printing'
		);
		$this->load->view('frontend/templates/header', $data);
	...
	public function pesanKartu()
	{
		...
		$data = array(
			'title' => 'Pesan Kartu Nama | Jadi Jaya Printing'
		);
		$this->load->view('frontend/templates/header', $data);
	...
	public function pesanBrosur()
	{
		...
		$data = array(
			'title' => 'Pesan Brosur | Jadi Jaya Printing'
		);
		$this->load->view('frontend/templates/header', $data);
	...
	public function pesanKalender()
	{
		if (isset($_POST['keranjang'])) {
			...
			$ukuran = $this->input->post('ukuran');
			$cetakisicover = $this->input->post('cetakisicover');
			$jumlahhalaman = $this->input->post('jumlahhalaman');
			$jumlah = $this->input->post('jumlah');
			$total = 0;
			if ($jumlahhalaman == '13') {
				$total =  $jumlah * 500000;
			} elseif ($jumlahhalaman == '6') {
				$total =  $jumlah * 750000;
			} elseif ($jumlahhalaman == '4') {
				$total =  $jumlah * 650000;
			} elseif ($jumlahhalaman == '1') {
				$total =  $jumlah * 550000;
			}
			...
			if (!$this->upload->do_upload('upload')) {
				...
				$dataKalender = array(
					...
					'kalender_cetakisicover' => $cetakisicover,
					'kalender_jumlahhalaman' => $jumlahhalaman,
		...
		$data = array(
			'title' => 'Pesan Kalender | Jadi Jaya Printing'
		);
		$this->load->view('frontend/templates/header', $data);
